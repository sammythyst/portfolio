        ...
        <div className='m-5'>
            ...
            <div style={project}>
                ...
                <div style={project}>
                    ...
                    <img src={require('../images/media-phile.jpg')} alt="media phile homepage with a couple posts from various users." style={img}/>
                </div>
                <div style={project}>
                    <div style={links}>
                    ...
                    <img src={require('../images/college-trip.jpg')} alt="webpage listing various colleges based on search term" style={img}/>
                </div>
                <div style={project}>
                    <div style={links}>
                    ...
                    <p>Tools: HTML, CSS, JavaScript, JSON</p>
                    <img src={require('../images/re-tcg.jpg')} alt="pokemon-like cards on a red and black starburst background" style={img}/>
                </div>
                {/* module 18 */}
                <div style={project}>
                    <div style={links}>
                    ...
                    <img src={require('../images/social-network-api.jpg')} alt="backend view of a social network's api" style={img}/>
                </div>
                {/* module 13 */}
                <div style={project}>
                    <div style={links}>
                    ...
                    <img src={require('../images/ecommerce-backend.jpg')} alt="backend view of ecommerce store" style={img}/>
                </div>
                {/* module 12 */}
                <div style={project}>
                    <div style={links}>
                    ...
                    <img src={require('../images/employee-tracker.jpg')} alt="a command line application of a company database" style={img}/>
                </div>
                 {/* module 10 */}
                <div style={project}>
                    <div style={links}>
                    ...
                    <p>Tools: Inquirer</p>
                    <img src={require('../images/team-profile.jpg')} alt="cards displaying names and information of various employees" style={img}/>
                </div>
                {/* module 6 */}
                <div style={project}>
                    <div style={links}>
                    ...
                    <img src={require('../images/weather-dashboard.jpg')} alt="a weather dashboard for Chicago with a 5 day forecast" style={img}/>
                </div>
                {/* module 5 */}
                <div style={project}>
                    <div style={links}>
                    ...
                    <img src={require('../images/work-day-scheduler.jpg')} alt="a vertically aligned time table starting with 9am and repeating every hour until 5pm, past hours are colored gray, the current hour is colored red, and future hours are colored green" style={img}/>
                </div>
                {/* module 4 */}
                <div style={project}>
                    <div style={links}>
                    ...
                    <p>Tools: HTML, CSS, JavaScript</p>
                    <img src={require('../images/code-quiz.jpg')} alt="text reading Coding Quiz Challenge with a blue start quiz button" style={img}/>
                </div>
                {/* module 3 */}
                <div style={project}>
                    <div style={links}>
                    ...
                    <p>Tools: HTML, CSS, JavaScript</p>
                    <img src={require('../images/password-generator.jpg')} alt="text box on white background with red button to generate a password" style={img}/>
                </div>
